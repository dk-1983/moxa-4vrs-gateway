...
## Автоматическая установка — следующий релиз

Автозагрузчик готовится для **v2026.01.00**. В опубликованном **v2026.00.01**
его ещё нет; для этой версии ниже сохранён ручной способ установки.

Планируемый порядок работы:

1. Скачайте и распакуйте установочный пакет.
2. Скопируйте его файлы в каталог Moxa, указанный в инструкции к пакету.
3. Подключитесь к Moxa и запустите автозагрузчик одной командой.
4. Дождитесь сообщения об успешной установке. Система сама проверит устройство
   и файлы, установит компоненты и настроит их запуск, сохранив текущую сеть.
5. Откройте главное меню Gateway и настройте подключённые приборы.

Редактировать системные конфигурационные файлы вручную не потребуется.
Точный каталог, команда запуска и ожидаемые сообщения будут добавлены после
испытаний готового пакета. Этот план пока не является инструкцией запуска
доступного установщика.
