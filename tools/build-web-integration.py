...
run([cc,*flags,*(['-Wl,--wrap=fsync'] if mode!='target' else []),root/'src/web/kdf_main.c',root/'src/web/web_protocol.c',root/'src/web/rng_client.c',out/'tls/libtls.a','-lrt','-o',out/'4vrs-kdf'])
