...
{if(!c)return;memset(c,0,sizeof(*c));c->schema_version=GATEWAY_CONFIG_SCHEMA_VERSION;c->settings.ntp_interval_hours=1U;gateway_configuration_defaults(c->ports);}
